...
def main():
    ...
    deep = Deep(x_train.shape[0], [48, 24, 1])
    iterations = 100000
    A, cost = deep.train(x_train, y_train, iterations=iterations, alpha=0.15)
    deep.save('census7_24_24_1_FULL_{}'.format(iterations))
    ...
    result.to_csv('census7_24_24_1_FULL_{}.csv'.format(iterations), index=False)
